...
<nav aria-label="Main Menu" class="gutter relative">
    ...
    <ul class="absolute md:static hidden md:flex right-0 bg-gray-100 md:bg-transparent shadow-2xl md:shadow-none md:flex-row mt-3 md:mt-0 mr-4 md:mr-0 lowercase" id="main-menu">
